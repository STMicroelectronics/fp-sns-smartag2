...
/* USER CODE BEGIN 1 */
/* Select if LPS22DF environmental sensor is used in the application OneShot */
#define USE_ENV_SENSOR_LPS22DF_0      1
/* Select if H3LIS331DL motion sensor is used in the application OneShot */
#define USE_MOTION_SENSOR_H3LIS331DL_0      0
/* Select if LIS2DUXS12 motion sensor is used in the application OneShot */
#define USE_MOTION_SENSOR_LIS2DUXS12_0      0
/* Select if STTS22H environmental sensor is used in the application OneShot */
#define USE_ENV_SENSOR_STTS22H_0      1
/* Select if LSM6DSO32X motion sensor is used in the application OneShot */
