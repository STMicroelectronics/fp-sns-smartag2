...
/** @defgroup STEVAL_SMARTAG2 STEVAL_SMARTAG2
 * @{
 */

/** @defgroup STEVAL_SMARTAG2_LOW_LEVEL STEVAL_SMARTAG2 LOW LEVEL
...
/** @defgroup STEVAL_SMARTAG2_LOW_LEVEL_Private_Defines STEVAL_SMARTAG2 LOW LEVEL Private Defines
 * @{
 */

/** @defgroup STEVAL_SMARTAG2_LOW_LEVEL_FunctionPrototypes STEVAL_SMARTAG2 LOW LEVEL Private Function Prototypes
 * @{
 */
...
/** @defgroup STEVAL_SMARTAG2_LOW_LEVEL_Private_Variables STEVAL_SMARTAG2 LOW LEVEL Private Variables
 * @{
 */
...
/** @defgroup STEVAL_SMARTAG2_LOW_LEVEL_Private_Functions STEVAL_SMARTAG2 LOW LEVEL Private Functions
 * @{
 */
...
{
  return (int32_t)__STEVAL_SMARTAG2_BSP_VERSION;
}
