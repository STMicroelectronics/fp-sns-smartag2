...
/**
  ******************************************************************************
  * @file    lis2duxs12_asset_tracking_lp.h
  * @author  MEMS Software Solutions Team
  * @version 1.2.0
  * @date    30-May-2023
  * @brief   This file contains the configuration for lis2duxs12_asset_tracking_lp.
  ******************************************************************************
  * @attention
  *
...
#ifndef LIS2DUXS12_ASSET_TRACKING_LP_H
#define LIS2DUXS12_ASSET_TRACKING_LP_H
...
static const ucf_line_ext_t at_lp[] = {
  ...
  { .op = MEMS_UCF_OP_WRITE, .address = 0x1A, .data = 0x03 },
  ...
  { .op = MEMS_UCF_OP_WRITE, .address = 0x0F, .data = 0x03 },
  ...
  { .op = MEMS_UCF_OP_WRITE, .address = 0x20, .data = 0x01 },
  ...
  { .op = MEMS_UCF_OP_WRITE, .address = 0x08, .data = 0x12 },
  { .op = MEMS_UCF_OP_WRITE, .address = 0x09, .data = 0x00 },
  { .op = MEMS_UCF_OP_WRITE, .address = 0x09, .data = 0x00 },
  { .op = MEMS_UCF_OP_WRITE, .address = 0x09, .data = 0x00 },
  { .op = MEMS_UCF_OP_WRITE, .address = 0x09, .data = 0x00 },
  ...
  { .op = MEMS_UCF_OP_WRITE, .address = 0x17, .data = 0x40 },
  { .op = MEMS_UCF_OP_WRITE, .address = 0x02, .data = 0x11 },
  { .op = MEMS_UCF_OP_WRITE, .address = 0x08, .data = 0x1E },
...
#endif /* LIS2DUXS12_ASSET_TRACKING_LP_H */
