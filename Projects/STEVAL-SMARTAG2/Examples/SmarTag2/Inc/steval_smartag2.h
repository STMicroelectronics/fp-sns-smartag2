...
#ifndef __STEVAL_SMARTAG2_H
#define __STEVAL_SMARTAG2_H
...
/** @defgroup STEVAL_SMARTAG2
 * @{
 */

/** @defgroup STEVAL_SMARTAG2_LOW_LEVEL
 * @{
 */
 ...
 */
#define __STEVAL_SMARTAG2_BSP_VERSION_MAIN   (uint32_t)(0x01) /*!< [31:24] main version */
#define __STEVAL_SMARTAG2_BSP_VERSION_SUB1   (uint32_t)(0x00) /*!< [23:16] sub1 version */
#define __STEVAL_SMARTAG2_BSP_VERSION_SUB2   (uint32_t)(0x00) /*!< [15:8]  sub2 version */
#define __STEVAL_SMARTAG2_BSP_VERSION_RC     (uint32_t)(0x00) /*!< [7:0]  release candidate */
#define __STEVAL_SMARTAG2_BSP_VERSION        ((__STEVAL_SMARTAG2_BSP_VERSION_MAIN << 24)\
                                                    |(__STEVAL_SMARTAG2_BSP_VERSION_SUB1 << 16)\
                                                    |(__STEVAL_SMARTAG2_BSP_VERSION_SUB2 << 8 )\
                                                    |(__STEVAL_SMARTAG2_BSP_VERSION_RC))

/** @defgroup STEVAL_SMARTAG2_LOW_LEVEL_Exported_Types STEVAL_SMARTAG2 LOW LEVEL Exported Types
 * @{
 */

 /**
  * @brief Define for STEVAL_SMARTAG2 board
  */
#if !defined (USE_STEVAL_SMARTAG2)
 #define USE_STEVAL_SMARTAG2
#endif
#ifndef USE_BSP_COM_FEATURE
   #define USE_BSP_COM_FEATURE                  0U
#endif

/** @defgroup STEVAL_SMARTAG2_LOW_LEVEL_LED STEVAL_SMARTAG2 LOW LEVEL LED
 * @{
 */
...
#define BUS_BSP_LED_GPIO_PIN GPIO_PIN_12

/**
 * @}
 */

/** @defgroup STEVAL_SMARTAG2_LOW_LEVEL_BUTTON STEVAL_SMARTAG2 LOW LEVEL BUTTON
 * @{
 */
/* Button state */
 ...
 * @}
 */
/** @defgroup STEVAL_SMARTAG2_LOW_LEVEL_COM STEVAL_SMARTAG2 LOW LEVEL COM
 * @{
 */
/**
...
/** @defgroup STEVAL_SMARTAG2_LOW_LEVEL_Exported_Types LOW LEVEL Exported Types
  * @{
  */
#ifndef USE_BSP_COM
...
/** @defgroup STEVAL_SMARTAG2_LOW_LEVEL_Exported_Functions STEVAL_SMARTAG2 LOW LEVEL Exported Functions
 * @{
 */
