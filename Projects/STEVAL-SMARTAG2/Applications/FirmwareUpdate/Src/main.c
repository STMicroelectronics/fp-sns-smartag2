...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, RST_SAFE_Pin|VDD_EEP_Pin|ACC_CS_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, HIGH_G_CS_Pin|VDD_SAF_CTRL_Pin|VDD_AMB_MCU_Pin|VDD_ACC_MCU_Pin
                          |LPD_Pin|CH_ON_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : INT_PRE_Pin GPO_Pin */
  GPIO_InitStruct.Pin = INT_PRE_Pin|GPO_Pin;
  ...
  /*Configure GPIO pins : ACC_INT1_Pin INT_TEM_Pin */
  GPIO_InitStruct.Pin = ACC_INT1_Pin|INT_TEM_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : RST_SAFE_Pin VDD_EEP_Pin ACC_CS_Pin */
  GPIO_InitStruct.Pin = RST_SAFE_Pin|VDD_EEP_Pin|ACC_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : ACC_INT2_Pin GPIO1_Pin */
  GPIO_InitStruct.Pin = ACC_INT2_Pin|GPIO1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
