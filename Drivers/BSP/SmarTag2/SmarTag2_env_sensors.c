...
static int32_t STTS22H_0_Probe(uint32_t Functions)
{
  ...
  io_ctx.ReadReg     = BSP_STTS22H_0_I2C_ReadReg;
  io_ctx.WriteReg    = BSP_STTS22H_0_I2C_WriteReg;
  ...
  else
  {
    ...
    EnvDrv[STTS22H_0] = (ENV_SENSOR_CommonDrv_t *)&STTS22H_COMMON_Driver;

    if ((ret == BSP_ERROR_NONE) && ((Functions & ENV_TEMPERATURE) == ENV_TEMPERATURE) && (cap.Temperature == 1U))
    {
      EnvFuncDrv[STTS22H_0][FunctionIndex[ENV_TEMPERATURE]] = (ENV_SENSOR_FuncDrv_t *)&STTS22H_TEMP_Driver;
...
static int32_t LPS22DF_0_Probe(uint32_t Functions)
{
  ...
  io_ctx.ReadReg     = BSP_LPS22DF_0_I2C_ReadReg;
  io_ctx.WriteReg    = BSP_LPS22DF_0_I2C_WriteReg;
  io_ctx.GetTick     = BSP_GetTick;
  ...
  else
  {
    ...
    EnvDrv[LPS22DF_0] = (ENV_SENSOR_CommonDrv_t *)&LPS22DF_COMMON_Driver;

    if ((ret == BSP_ERROR_NONE) && ((Functions & ENV_TEMPERATURE) == ENV_TEMPERATURE) && (cap.Temperature == 1U))
    {
      EnvFuncDrv[LPS22DF_0][FunctionIndex[ENV_TEMPERATURE]] = (ENV_SENSOR_FuncDrv_t *)&LPS22DF_TEMP_Driver;
    ...
    {
      EnvFuncDrv[LPS22DF_0][FunctionIndex[ENV_PRESSURE]] = (ENV_SENSOR_FuncDrv_t *)&LPS22DF_PRESS_Driver;
