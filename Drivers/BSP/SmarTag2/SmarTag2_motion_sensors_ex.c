/**
  ******************************************************************************
  * @file    SmarTag2_motion_sensors_ex.c
  * @author  System Research & Applications Team - Catania & Agrate Lab.
  * @version 1.0.0
  * @date    31-August-2022
  * @brief   This file provides BSP Motion Sensors Extended interface for
  *          SmarTag2 board
  ******************************************************************************
  * @attention
  *
...
#if (USE_MOTION_SENSOR_LSM6DSO32X_0 == 1)
    case LSM6DSO32X_0:
      /* For LSM6DSO32X the Wake Up event can be routed for INT1 pin and INT2 pin */
      if (LSM6DSO32X_ACC_Enable_Wake_Up_Detection(MotionCompObj[Instance], (LSM6DSO32X_SensorIntPin_t) IntPin) != BSP_ERROR_NONE)
      {
        ret = BSP_ERROR_COMPONENT_FAILURE;
      }
      else
...
#if (USE_MOTION_SENSOR_LSM6DSO32X_0 == 1)
    case LSM6DSO32X_0:
      if (LSM6DSO32X_ACC_Set_Wake_Up_Threshold(MotionCompObj[Instance], Threshold) != BSP_ERROR_NONE)
      {
        ret = BSP_ERROR_COMPONENT_FAILURE;
      }
      else
...
#if (USE_MOTION_SENSOR_LSM6DSO32X_0 == 1)
    case LSM6DSO32X_0:
      if (LSM6DSO32X_ACC_Disable_6D_Orientation(MotionCompObj[Instance]) != BSP_ERROR_NONE)
      {
        ret = BSP_ERROR_COMPONENT_FAILURE;
      }
      else
...
#if (USE_MOTION_SENSOR_LSM6DSO32X_0 == 1)
    case LSM6DSO32X_0:
      if (LSM6DSO32X_ACC_Get_6D_Orientation_XH(MotionCompObj[Instance], xh) != BSP_ERROR_NONE)
      {
        ret = BSP_ERROR_COMPONENT_FAILURE;
      }
      else
...
#if (USE_MOTION_SENSOR_LSM6DSO32X_0 == 1)
    case LSM6DSO32X_0:
      if (LSM6DSO32X_ACC_Get_6D_Orientation_YH(MotionCompObj[Instance], yh) != BSP_ERROR_NONE)
      {
        ret = BSP_ERROR_COMPONENT_FAILURE;
      }
      else
...
#if (USE_MOTION_SENSOR_LSM6DSO32X_0 == 1)
    case LSM6DSO32X_0:
      if (LSM6DSO32X_ACC_Get_6D_Orientation_ZL(MotionCompObj[Instance], zl) != BSP_ERROR_NONE)
      {
        ret = BSP_ERROR_COMPONENT_FAILURE;
      }
      else
...
int32_t BSP_MOTION_SENSOR_Get_Event_Status(uint32_t Instance, BSP_MOTION_SENSOR_Event_Status_t *Status)
{
  ...
  switch (Instance)
  {
    ...
    case LSM6DSO32X_0:
      ...
      if (LSM6DSO32X_ACC_Get_Event_Status(MotionCompObj[Instance], (LSM6DSO32X_Event_Status_t *)(void *)Status) != BSP_ERROR_NONE)
      {
        ret = BSP_ERROR_COMPONENT_FAILURE;
      }
      else
