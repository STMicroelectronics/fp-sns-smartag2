...
__weak HAL_StatusTypeDef SMARTAG2_I2C1_Init(I2C_HandleTypeDef* hi2c);
__weak HAL_StatusTypeDef SMARTAG2_SPI1_Init(SPI_HandleTypeDef* hspi);
__weak HAL_StatusTypeDef SMARTAG2_I2C2_Init(I2C_HandleTypeDef* hi2c);
__weak HAL_StatusTypeDef SMARTAG2_I2C3_Init(I2C_HandleTypeDef* hi2c);
...
/** @defgroup SMARTAG2_BUS_Exported_Variables BUS Exported Variables
  * @{
  */
...
/** @defgroup SMARTAG2_BUS_Private_Variables BUS Private Variables
  * @{
  */
...
/** @defgroup SMARTAG2_BUS_Private_FunctionPrototypes  BUS Private Function
  * @{
  */
...
/** @defgroup SMARTAG2_BUS_Exported_Functions SMARTAG2_BUS Exported Functions
  * @{
  */
  ...
  if(I2C1InitCounter++ == 0U)
  {
    if (HAL_I2C_GetState(&hi2c1) == HAL_I2C_STATE_RESET)
    {
     ...
     // if(ret == BSP_ERROR_NONE)
      {
        /* Init the I2C */
        if(SMARTAG2_I2C1_Init(&hi2c1) != HAL_OK)
        {
...
int32_t BSP_SPI1_Init(void)
{
  ...
  if(SPI1InitCounter++ == 0U)
  {
    if (HAL_SPI_GetState(&hspi1) == HAL_SPI_STATE_RESET)
    {
        ...
        {
            /* Init the SPI */
            if (SMARTAG2_SPI1_Init(&hspi1) != HAL_OK)
            {
                ret = BSP_ERROR_BUS_FAILURE;
            }
        }
  ...
  if(I2C2InitCounter++ == 0U)
  {
    if (HAL_I2C_GetState(&hi2c2) == HAL_I2C_STATE_RESET)
    {
     ...
     // if(ret == BSP_ERROR_NONE)
      {
        /* Init the I2C */
        if(SMARTAG2_I2C2_Init(&hi2c2) != HAL_OK)
        {
          ret = BSP_ERROR_BUS_FAILURE;
        }
...
int32_t BSP_I2C3_Init(void)
{
  ...
  if(I2C3InitCounter++ == 0U)
  {
    if (HAL_I2C_GetState(&hi2c3) == HAL_I2C_STATE_RESET)
    {
      ...
      {
        /* Init the I2C */
        if(SMARTAG2_I2C3_Init(&hi2c3) != HAL_OK)
        {
          ret = BSP_ERROR_BUS_FAILURE;
        }
...
{
  int32_t ret =  (int32_t)HAL_I2C_IsDeviceReady(&hi2c3, DevAddr, Trials, BUS_I2C3_POLL_TIMEOUT);
...
{
  if( hi2c3.ErrorCode == HAL_I2C_ERROR_AF )
  {
    return I2CANSW_NACK;
  }
  return I2CANSW_ACK;
...
int32_t BSP_GetTick(void) {
  int32_t ret = (int32_t)HAL_GetTick();
  return ret;
}
